...
St.plugins.htmleditor.HeadingButtons = Ext.extend(St.plugins.htmleditor.MidasCommand, {
    // private
    midasBtns: ['|', {
...
Ext.preg('St.plugins.htmleditor.HeadingButtons', St.plugins.htmleditor.HeadingButtons);
 ...
 */
St.plugins.htmleditor.HeadingMenu = Ext.extend(Ext.util.Observable, {
    init: function(cmp){
        this.cmp = cmp;
...
Ext.preg('St.plugins.htmleditor.HeadingMenu', St.plugins.htmleditor.HeadingMenu);