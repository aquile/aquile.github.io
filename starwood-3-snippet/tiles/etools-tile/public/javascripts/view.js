...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_View2.default, null), document.body); // В бади запихнем DOM из Configuration.js
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $                 = __webpack_require__(163)
	  ...
	  , IE_PROTO          = __webpack_require__(172)('__proto__')
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(210)('freeze', function($freeze){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(210)('seal', function($seal){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(210)('preventExtensions', function($preventExtensions){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(210)('isFrozen', function($isFrozen){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(210)('isSealed', function($isSealed){
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(210)('getPrototypeOf', function($getPrototypeOf){
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 19.1.2.7 Object.getOwnPropertyNames(O)
	__webpack_require__(210)('getOwnPropertyNames', function(){
	  return __webpack_require__(198).get;
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $           = __webpack_require__(163)
	  ...
	  , fails       = __webpack_require__(170)
	  , $trim       = __webpack_require__(224).trim
	  , NUMBER      = 'Number'
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(167)(IteratorPrototype, __webpack_require__(192)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UNSCOPABLES = __webpack_require__(192)('unscopables')
	  , ArrayProto  = Array.prototype;
	if(ArrayProto[UNSCOPABLES] == undefined)__webpack_require__(167)(ArrayProto, UNSCOPABLES, {});
	module.exports = function(key){
...
/***/ function(module, exports, __webpack_require__) {
	...
	// @@match logic
	__webpack_require__(293)('match', 1, function(defined, MATCH){
...
/***/ function(module, exports, __webpack_require__) {
	...
	// @@search logic
	__webpack_require__(293)('search', 1, function(defined, SEARCH){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $          = __webpack_require__(163)
	  ...
	  , anObject   = __webpack_require__(181)
	  , aFunction  = __webpack_require__(174)
	  , strictNew  = __webpack_require__(298)
	...
	Wrapper = __webpack_require__(166)[PROMISE];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global    = __webpack_require__(165)
	  ...
	  , isNode    = __webpack_require__(179)(process) == 'process'
	  , head, last, notify;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(!setTask || !clearTask){
	  ...
	  // Node.js 0.8-
	  if(__webpack_require__(179)(process) == 'process'){
	    defer = function(id){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hide              = __webpack_require__(167)
	  ...
	  , createArrayMethod = __webpack_require__(189)
	  , $has              = __webpack_require__(178)
	  , WEAK              = __webpack_require__(172)('weak')
	  , isExtensible      = Object.isExtensible || isObject
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $         = __webpack_require__(163)
	  ...
	  , anObject  = __webpack_require__(181)
	  , isObject  = __webpack_require__(177)
	  , bind      = Function.bind || __webpack_require__(166).Function.prototype.bind;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(224)('trimLeft', function($trim){
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	// https://github.com/sebmarkbage/ecmascript-string-left-right-trim
	__webpack_require__(224)('trimRight', function($trim){
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P, 'Map', {toJSON: __webpack_require__(340)('Map')});
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P, 'Set', {toJSON: __webpack_require__(340)('Set')});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $       = __webpack_require__(163)
	  , $export = __webpack_require__(164)
	  , $ctx    = __webpack_require__(173)
	  , $Array  = __webpack_require__(166).Array || Array
	  , statics = {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _apiHelper = __webpack_require__(351);

	var api = _interopRequireWildcard(_apiHelper);
	...
	// all from '../helpers/apiHelper' import here
	...
	var Root = function (_Component) {
	    ...
	    _createClass(Root, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            var root = _reactDom2.default.findDOMNode(this); // get  .eTools-main-wrp
	            var scroll = root.querySelector('#eTools-list-wrp');
	            $(scroll).niceScroll({ cursorcolor: "#3f7793" });

	            api.resize();

	            api.getConfig().then(function (config) {
	                _this2.setState({ tileTitle: config.tileTitle, message: config.message });

	                return api.getSpaceTree(config.ID);
	            }).then(function (spaces) {
	                return _this2.setState({ spaces: spaces });
	        ...
	        value: function render() {
	            ...
	            var tileTitle = _state.tileTitle;
	            var spaces = _state.spaces;
	            ...
	            if (error) {
	                return _react2.default.createElement(
	                    'div',
	                    { className: 'eTools-main-wrp' },
	                    _react2.default.createElement(
	                        'h2',
	                        { className: 'eTools-title' },
	                        tileTitle
	                    ),
	                    _react2.default.createElement(
	                        'p',
	            ...
	            if (searchQuery) {
	                filteredSpaces = filteredSpaces.filter(function (space) {
	                    return space.name.toUpperCase().indexOf(searchQuery.toUpperCase()) !== -1;
	                });
	            }
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'label',
	                    null,
	                    _react2.default.createElement('input', { className: 'eTools-search-input', type: 'text',
	                        value: searchQuery,
	                        onChange: function onChange(e) {
	                            return _this3.setState({ searchQuery: e.target.value });
	                        },
	                        placeholder: 'search a tool or application' })
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'eTools-list-wrp', id: 'eTools-list-wrp' },
	                    filteredSpaces.map(function (space, index) {
	                        return _react2.default.createElement(
	                            'a',
	                            { key: index, className: 'eTools-link', href: space.url, target: '_blank' },
	                            _react2.default.createElement(
	                                'p',
	                                { className: 'eTools-name' },
	                                space.name
	                            )
	                        );
	                    })
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getChildPlaces = getChildPlaces;
	exports.getSpaceTree = getSpaceTree;
	exports.resize = resize;

	var _underscore = __webpack_require__(352);
	...
	function getPlace(ID) {
	    return new Promise(function (resolve, reject) {
	        return osapi.jive.corev3.places.get({ entityDescriptor: [JIVE_PLACE_TYPE_ID, ID] }).execute(function (osapiResponse) {
	...
	function getSpaceTree(parentPlacecID) {
	    return new Promise(function (resolve, reject) {
	        var resultSpaces = [];

	        Promise.all([getPlace(parentPlacecID)]).then(iteration).catch(reject);

	        function iteration(places) {
	            var spaces = places.filter(function (place) {
	                return place.type === 'space';
	            });

	            if (!spaces.length) {
	                resultSpaces = resultSpaces.sort(function (s1, s2) {
	            ...
	            var promises = spaces.map(getChildPlaces);

	            Promise.all(promises).then(unwind).then(iteration).catch(reject);
	        }
	    });
	}
	...
	function unwind(arrayOfArrays) {
	    return arrayOfArrays.reduce(function (result, subarray) {
	        return [].concat(_toConsumableArray(result), _toConsumableArray(subarray));
	    }, []);
	}
