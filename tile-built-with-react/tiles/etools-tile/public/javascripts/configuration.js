...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Configuration = __webpack_require__(349);
	...
	_reactDom2.default.render(_react2.default.createElement(_Configuration2.default, null), document.body); // В бади запихнем DOM из Configuration.js
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Configuration = function (_Component) {
	    ...
	    function Configuration() {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Configuration).call(this));
	    ...
	    _createClass(Configuration, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'h2',
	                    null,
	                    'Configure eTools Tile'
	                ),
	                _react2.default.createElement(
	                    'form',
	                    { className: 'trending-form', onSubmit: function onSubmit(e) {
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement('input', { type: 'text',
	                                onChange: function onChange(e) {
	                                    return _this2.setState({ tileTitle: e.target.value });
	                                },
	                                value: tileTitle })
	                        )
	                    ),
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'p',
	                            null,
	                            'Set default message if user does not have access to any spaces'
	                        ),
	                        _react2.default.createElement(
	                            'p',
	                            null,
	        ...
	        value: function onConfig(config) {
	            if (config.data) {
	                ...
	                var tileTitle = _config$data.tileTitle;
	                var ID = _config$data.ID;
	                var message = _config$data.message;

	                this.setState({ tileTitle: tileTitle, ID: ID, message: message });
